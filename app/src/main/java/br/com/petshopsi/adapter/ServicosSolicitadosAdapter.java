...
public class ServicosSolicitadosAdapter extends ArrayAdapter<ServicosSolicitados> {

    private ArrayList<ServicosSolicitados> servicosSolicitados;
    private Context context;

    public ServicosSolicitadosAdapter(Context c, ArrayList<ServicosSolicitados> objects) {
        super(c, 0, objects);
