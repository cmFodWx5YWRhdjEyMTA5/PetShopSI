...
public class AtenderServicosSolicitadosAdapter extends ArrayAdapter<ServicosSolicitados> {

    private ArrayList<ServicosSolicitados> servicosSolicitados;
    private Context context;

    public AtenderServicosSolicitadosAdapter(Context c, ArrayList<ServicosSolicitados> objects) {
        super(c, 0, objects);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (servicosSolicitados != null) {
            ...
            view = inflater.inflate(R.layout.itens_atender_servicos_solicitados, parent, false);
