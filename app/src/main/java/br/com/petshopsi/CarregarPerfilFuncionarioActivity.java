...
public class CarregarPerfilFuncionarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carregar_perfil_funcionario);
    ...
    public  void verificarPerfilUsuario(){
        ...
        databaseRef = ConfiguracaoFirebase.getFirebase().child("Funcionarios").child(identificadorUsuario);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    try {
                        ...
                        if (perfil.equals("Funcionario") == true){
                            ...
                            Toast.makeText(CarregarPerfilFuncionarioActivity.this, "Erro de Perfil. Contate o administrador", Toast.LENGTH_SHORT).show();
                            progressBarPerfil.setVisibility(View.GONE);
                            finish();
