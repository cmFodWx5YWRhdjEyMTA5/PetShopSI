    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(LoginClienteActivity.this, "Ocorreu um erro ao efetuar o login. Tente novamente mais tarde.", Toast.LENGTH_SHORT).show();
                }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(LoginClienteActivity.this, "Reset Link Sent To Your Email.", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(LoginClienteActivity.this, "Error ! Reset Link is Not Sent" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        criarConta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TESTE CRIAR SERVICO
                Intent intent = new Intent(LoginClienteActivity.this, CadastraFuncionario.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(LoginClienteActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
